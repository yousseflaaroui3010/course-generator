...
// In-memory database for MVP (replaced by PostgreSQL in US-11.1)
...
async function startServer() {
  ...
  // Vite middleware for development — root points to client/ workspace
  ...
  app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`Client root: ${path.join(PROJECT_ROOT, 'client')}`);
  });
}
